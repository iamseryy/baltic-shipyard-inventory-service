package ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.lot
...
data class LotDetailDto(
    ...
    @JsonProperty(JsonFieldsProvider.EFFECTIVITY_UNIT_CODE) val effectivityUnit: Long,
