...
import ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.measuredremainder.message.MeasuredRemainderFilterRequestMessage
import ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.measuredremainder.message.MeasuredRemainderUpdateResponseMessage
import ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.measuredremainder.message.MeasuredRemainderUpdateRequestMessage
import ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.measuredremainder.message.MeasuredRemaindersPageResponseMessage
import ru.bz.baltic_shipyard_inventory_service.infrastructure.messaging.rabbit.dto.measuredremainder.message.toDomainPage
    ...
    override fun findPage(filter: MeasuredRemainderFilter, pageRequest: DomainPageRequest): DomainPage<MeasuredRemainder>? =
        with(
            ...
            try {
                ...
                logger.error(e) { "RabbitMQ RPC timeout" }
                throw ExternalServiceTimeoutException("RabbitMQ RPC timeout", e)
            }
        }
