...
data class UpdateMeasuredRemainderTransactionDto(
...
fun UpdatableMeasuredRemainder.toUpdateMeasuredRemainderTransactionDto() = UpdateMeasuredRemainderTransactionDto(
    id = transaction.id,
