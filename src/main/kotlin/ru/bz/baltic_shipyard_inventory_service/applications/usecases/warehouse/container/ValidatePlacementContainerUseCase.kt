...
@Component
class ValidatePlacementContainerUseCase(
            ...
            if (container != null &&
                    inventoryUseCases.findInventoryBalanceByFilter(
                        SearchInventoryBalanceFilter(
                            warehouseCode = container.location.warehouseCode,
                            binCode = placementContainer.binCodeTarget
                        )
