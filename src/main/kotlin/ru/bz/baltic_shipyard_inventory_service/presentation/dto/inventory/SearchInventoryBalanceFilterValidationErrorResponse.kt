...
private const val FIELD_BIN_CODE = "binCode"
...
data class SearchInventoryBalanceFilterValidationErrorResponse(
    @Schema(description="schema.warehouse.code.desc", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty(JsonFields.WAREHOUSE_CODE) val warehouseCode: ViolationDto? = null,

    @Schema(description="schema.bin.code.desc", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty(JsonFields.BIN_CODE) val binCode: ViolationDto? = null,
    ...
    class EntryBuilder {
        ...
        fun build() = SearchInventoryBalanceFilterValidationErrorResponse(
        ...
        fun build(fieldErrors: List<FieldError>): SearchInventoryBalanceFilterValidationErrorResponse {
