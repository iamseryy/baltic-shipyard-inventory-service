...
data class MeasuredRemainderForUpdateViolationByFieldDto(
...
)
{
    class EntryBuilder {
        ...
        fun build() = MeasuredRemainderForUpdateViolationByFieldDto(
            id = id,
            status = status,
            comment = comment,
            length = length,
        ...
        fun build(fieldErrors: List<FieldError>): MeasuredRemainderForUpdateViolationByFieldDto {
